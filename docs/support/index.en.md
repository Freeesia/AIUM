...
layout: page
title: Support
description: Support information for AIUM.
lang: en
...
See the [AIUM Privacy Policy]({% link privacy/index.en.md %}) for details about local storage, service communication, and deletion.
